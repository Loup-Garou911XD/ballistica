...
# Our asset-package wrapper module lives inside babase's package --
# asset handles are per-package-flavor, and the babase flavor is what
# BaseAssetSet slots take, same as bauiv1/_classicassets.py. So
